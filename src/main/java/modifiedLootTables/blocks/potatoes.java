...
public class potatoes implements customCropTable {
    public potatoes(NamespacedKey key) {
    ...
    public @NotNull Collection<ItemStack> populateLoot(@Nullable Random random, @NotNull LootContext lootContext) {
        ...
        items.add(new ItemStack(Material.POTATO, (getLootValue() + (getLootValue() % 2)) - 1));
        return items;
    }
