...
public class netherwart implements customCropTable {
    public netherwart(NamespacedKey key) {
    ...
    public @NotNull Collection<ItemStack> populateLoot(@Nullable Random random, @NotNull LootContext lootContext) {
        ...
        items.add(new ItemStack(Material.NETHER_WART, (getLootValue() + (getLootValue() % 2)) - 1));
        return items;
    }
