...
public class brownMushroom implements customCropTable {
    public brownMushroom(NamespacedKey key) {
    ...
    public @NotNull Collection<ItemStack> populateLoot(@Nullable Random random, @NotNull LootContext lootContext) {
        ...
        items.add(new ItemStack(Material.BROWN_MUSHROOM, getLootValue()));
