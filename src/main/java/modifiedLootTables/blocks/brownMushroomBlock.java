...
public class brownMushroomBlock implements customCropTable {
    public brownMushroomBlock(NamespacedKey key) {
    ...
    public @NotNull Collection<ItemStack> populateLoot(@Nullable Random random, @NotNull LootContext lootContext) {
        ...
        items.add(new ItemStack(Material.BROWN_MUSHROOM, (getLootValue())*2));
        items.add(new ItemStack(Material.BROWN_MUSHROOM, (getLootValue() % 2)*2));
        return items;
    }
