...
public class redMushroomBlock implements customCropTable {
    public redMushroomBlock(NamespacedKey key) {
    ...
    public @NotNull Collection<ItemStack> populateLoot(@Nullable Random random, @NotNull LootContext lootContext) {
        ...
        items.add(new ItemStack(Material.RED_MUSHROOM, (getLootValue())*2));
        items.add(new ItemStack(Material.RED_MUSHROOM, (getLootValue() % 2)*2));
        return items;
    }
